...
public class ZkClient {
    ...
    public ZkClient(String hosts, String nameSpace, ExponentialBackoffRetry retryStrategy) {
        this.hosts = hosts;
     ...
     *
     * @param dir make sure your dir is root path
     * @return
     */
    public boolean mkdirs(String dir) {
        try {
            EnsurePath clientAppPathExist = new EnsurePath("/" + client.getNamespace() + slash(dir));
    ...
    private String slash(String dir) {
    ...
    public ChildWatcher newChildWatcher(String path, ChildListener listener) {
        return newChildWatcher(path, listener, true);
    }
